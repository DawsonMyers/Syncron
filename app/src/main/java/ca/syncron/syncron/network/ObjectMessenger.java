...
//import   ca.syncron.syncron.system.Syncron.setMsgObj;
...
public static String HomeIP   = "192.168.1.109";    ////////////////////////////////
		MsgObject msgObj = new MsgObject();
public static String IP          = HomeIP; //syncronIP;
...
public void run() {
	...
	try (
			    Socket socket = new Socket(IP, mObjectPort);
			    // get Input stream FIRST
